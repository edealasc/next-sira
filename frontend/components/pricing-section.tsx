  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Perfect for developers just starting their journey.",
      features: [
        "Access to community forums",
        "Basic code review requests (2/month)",
        "Group mentorship sessions",
        "Learning resource library",
        "Profile matching with junior-friendly mentors",
      ],
    ...
    },
    {
      ...
      monthlyPrice: "$49",
      annualPrice: "$39",
      description: "Ideal for developers ready to level up.",
      features: [
        "Unlimited code reviews",
        "1-on-1 mentorship sessions (4 hours/month)",
    ...
    },
    {
      ...
      features: [
        "Team-wide mentorship programs",
        "Dedicated senior developer mentors",
        "Custom learning paths and goals",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Mentorship plans for every developer
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your learning goals, from curious beginners to <br /> growing developers and entire
            development teams.
          </p>
        </div>
        <div className="pt-4">
        ...
        {pricingPlans.map((plan) => (
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Explorer" ? "text-gray-800" : plan.name === "Mentee" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              >
                {plan.name === "Explorer" ? "Get Started today:" : "Everything in Explorer +"}
              </div>
